    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                LoginService.LoginCredentials loginCredentials = new LoginService.LoginCredentials(user);
                LoginService.LoginDetails loginDetails = loginService.login(loginCredentials);
                ...
                if (loginDetails.isSuccess()) {
                    ...
                    editor.putString(getString(R.string.auth_token), loginDetails.getAuth_token());
                    editor.commit();
